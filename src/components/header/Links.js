...
import { PlusSquare, PieChart, Bookmark } from "react-feather";
const Links = () => {
  return (
    <>
      <NavLink
        activeClassName="active-main-link"
        className="main-link nav-link svgf"
        to="/"
        exact={true}
      >
        <svg
          ...
          width="20px"
          height="20px"
          viewBox="0 0 402.871 402.871"
        >
          <g id="XMLID_458_">
            <path
              id="XMLID_459_"
              d="M357.902,248.308c0-35.981-17.415-75.958-43.334-99.478c-10.229-9.281-16.096-22.599-16.096-36.537v-86.5
            ...
            <path
              id="XMLID_464_"
              d="M101.001,344.695h96.225v-96.225h-96.225V344.695z M131.001,278.471h36.225v36.225h-36.225V278.471z"
            />
          </g>
        </svg>
        Vinsamling
